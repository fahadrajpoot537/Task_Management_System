                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <div>{{ $lead->project ? $lead->project->title . ' > General' : 'General > General' }}
                                    </div>
                                </div>
                                <div class="mb-3">
                                                    ...
                                                    <td>
                                                        ...
                                                        @else
                                                            <button class="btn btn-sm btn-primary"
                                                                onclick="editActivity({{ $activity->id }})" title="Edit">
    ...
    <div class="modal fade" id="activityModal" tabindex="-1">
        <div class="modal-dialog modal-lg">
            <div class="modal-content" style="background-color: #fff;">
                <div class="modal-header" id="activityModalHeader" style="background-color: #fff; border-bottom: 1px solid #dee2e6;">
                    <div class="d-flex justify-content-between align-items-center w-100">
                        <h4 class="modal-title mb-0 fw-bold text-dark" id="activityModalLabel" style="font-size: 1.5rem;">Create Activity</h4>
                        <div class="d-flex align-items-center gap-2">
                            <a href="#" class="text-decoration-none text-primary small" id="viewCalendarLink" style="display: none;">
                                <i class="bi bi-calendar3 me-1"></i>View Calendar
                            </a>
                            <a href="{{ route('leads.show', $lead->id) }}" target="_blank" class="text-decoration-none text-primary small" id="openLeadLink" style="display: none;">
                ...
                <form id="activityForm">
                    <div class="modal-body" id="activityModalBody" style="background-color: #fff;">
                            ...
                            <div class="row mb-4">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <span class="text-muted" id="contactReference" style="color: #6c757d;">{{ $lead->first_name }} {{ $lead->last_name }} ({{ $lead->flg_reference ?: 'N/A' }})</span>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <strong class="text-dark d-block mb-1" style="font-weight: 600;">Status & Assigned User</strong>
                                        <span class="text-muted" id="statusAssignedUser" style="color: #6c757d;">{{ $lead->status ? $lead->status->name : 'New' }}@if($lead->addedBy) ({{ $lead->addedBy->name }})@endif</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="taskSpecificSection" style="display: none;">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="row g-2 mb-2">
                                    ...
                                    <div class="col-md-8 d-flex align-items-center">
                                        <div class="form-check me-3">
                                            <input class="form-check-input" type="checkbox" id="taskPrioritise" name="priority_check">
                                            <label class="form-check-label" for="taskPrioritise">Prioritise</label>
                                        </div>
                                        <a href="javascript:void(0);" class="text-decoration-none text-primary small" id="addEndDateTimeLink" onclick="toggleEndDateTime()">
                                ...
                                <div id="taskDateTimeSection">
                                    <div class="row g-2 mb-2">
                                        <div class="col-auto">
                                            <select class="form-select form-select-sm" id="taskDueMonth" name="task_due_month" style="width: 80px;">
                                                @for($i = 1; $i <= 12; $i++)
                                                    <option value="{{ str_pad($i, 2, '0', STR_PAD_LEFT) }}" {{ date('m') == $i ? 'selected' : '' }}>{{ str_pad($i, 2, '0', STR_PAD_LEFT) }}</option>
                                                @endfor
                                            </select>
                                        </div>
                                        <div class="col-auto">
                                            <select class="form-select form-select-sm" id="taskDueDay" name="task_due_day" style="width: 70px;">
                                                @for($i = 1; $i <= 31; $i++)
                                                    <option value="{{ str_pad($i, 2, '0', STR_PAD_LEFT) }}" {{ date('d') == $i ? 'selected' : '' }}>{{ str_pad($i, 2, '0', STR_PAD_LEFT) }}</option>
                                                @endfor
                                            </select>
                                        </div>
                                        <div class="col-auto">
                                            <select class="form-select form-select-sm" id="taskDueYear" name="task_due_year" style="width: 90px;">
                                        ...
                                        <div class="col-auto">
                                            <select class="form-select form-select-sm" id="taskDueHour" name="task_due_hour" style="width: 70px;">
                                                @for($i = 0; $i <= 23; $i++)
                                                    <option value="{{ str_pad($i, 2, '0', STR_PAD_LEFT) }}" {{ date('H') == $i ? 'selected' : '' }}>{{ str_pad($i, 2, '0', STR_PAD_LEFT) }}</option>
                                                @endfor
                                            </select>
                                        </div>
                                        <div class="col-auto">
                                            <select class="form-select form-select-sm" id="taskDueMinute" name="task_due_minute" style="width: 70px;">
                                                @for($i = 0; $i <= 59; $i += 1)
                                                    <option value="{{ str_pad($i, 2, '0', STR_PAD_LEFT) }}" {{ date('i') == $i ? 'selected' : '' }}>{{ str_pad($i, 2, '0', STR_PAD_LEFT) }}</option>
                                                @endfor
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div id="endDateTimeSection" style="display: none;" class="mt-3">
                                    ...
                                    <div class="row g-2">
                                        <div class="col-auto">
                                            <select class="form-select form-select-sm" id="taskEndMonth" name="task_end_month" style="width: 80px;">
                                                @for($i = 1; $i <= 12; $i++)
                                        ...
                                        <div class="col-auto">
                                            <select class="form-select form-select-sm" id="taskEndDay" name="task_end_day" style="width: 70px;">
                                                @for($i = 1; $i <= 31; $i++)
                                                    <option value="{{ str_pad($i, 2, '0', STR_PAD_LEFT) }}">{{ str_pad($i, 2, '0', STR_PAD_LEFT) }}</option>
                                                @endfor
                                            </select>
                                        ...
                                        <div class="col-auto">
                                            <select class="form-select form-select-sm" id="taskEndYear" name="task_end_year" style="width: 90px;">
                                                @for($i = date('Y'); $i <= date('Y') + 5; $i++)
                                        ...
                                        <div class="col-auto">
                                            <select class="form-select form-select-sm" id="taskEndHour" name="task_end_hour" style="width: 70px;">
                                                @for($i = 0; $i <= 23; $i++)
                                                    <option value="{{ str_pad($i, 2, '0', STR_PAD_LEFT) }}">{{ str_pad($i, 2, '0', STR_PAD_LEFT) }}</option>
                                                @endfor
                                            </select>
                                        ...
                                        <div class="col-auto">
                                            <select class="form-select form-select-sm" id="taskEndMinute" name="task_end_minute" style="width: 70px;">
                                                @for($i = 0; $i <= 59; $i += 1)
                                                    <option value="{{ str_pad($i, 2, '0', STR_PAD_LEFT) }}">{{ str_pad($i, 2, '0', STR_PAD_LEFT) }}</option>
                                                @endfor
                                            </select>
                            ...
                            <div class="mb-4">
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    ...
                                    <div class="dropdown">
                                        <button class="btn btn-sm btn-outline-secondary dropdown-toggle" type="button" id="insertTextDropdown" data-bs-toggle="dropdown">
                                            Insert Text
                                        </button>
                                        <ul class="dropdown-menu" aria-labelledby="insertTextDropdown">
                                            <li><a class="dropdown-item" href="javascript:void(0);" onclick="insertTaskText('Call Requested')">Call Requested</a></li>
                                            <li><a class="dropdown-item" href="javascript:void(0);" onclick="insertTaskText('Make Initial Call')">Make Initial Call</a></li>
                                            <li><a class="dropdown-item" href="javascript:void(0);" onclick="insertTaskText('Send Initial Email')">Send Initial Email</a></li>
                                            <li><a class="dropdown-item" href="javascript:void(0);" onclick="insertTaskText('Send Initial Letter')">Send Initial Letter</a></li>
                                            <li><a class="dropdown-item" href="javascript:void(0);" onclick="insertTaskText('Make Follow-Up Call')">Make Follow-Up Call</a></li>
                                            <li><a class="dropdown-item" href="javascript:void(0);" onclick="insertTaskText('Send Follow-Up Email')">Send Follow-Up Email</a></li>
                                            <li><a class="dropdown-item" href="javascript:void(0);" onclick="insertTaskText('Send Follow-Up Letter')">Send Follow-Up Letter</a></li>
                                            <li><a class="dropdown-item" href="javascript:void(0);" onclick="insertTaskText('Review Lead')">Review Lead</a></li>
                                            <li><a class="dropdown-item" href="javascript:void(0);" onclick="insertTaskText('Process Lead')">Process Lead</a></li>
                                            <li><a class="dropdown-item" href="javascript:void(0);" onclick="insertTaskText('Close Lead')">Close Lead</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <textarea class="form-control" id="taskDetails" name="field_1" rows="8" placeholder="Enter task details..." style="resize: vertical; border: 1px solid #dee2e6;"></textarea>
                            </div>

                            <!-- Bottom Action Section -->
                            <div class="mb-3">
                                <div class="form-check mb-2">
                                    <input class="form-check-input" type="checkbox" id="assignLeadToUser" name="assign_lead_to_user">
                                    <label class="form-check-label" for="assignLeadToUser">Assign Lead to User</label>
                                </div>
                                <div class="form-check mb-2">
                                    <input class="form-check-input" type="checkbox" id="createTaskCheck" name="create_task_check" checked>
                                    <label class="form-check-label" for="createTaskCheck">Create a</label>
                                    <select class="form-select form-select-sm d-inline-block ms-2" id="createTaskType" name="create_task_type" style="width: 120px; display: inline-block;">
                        ...
                        <div id="eventSpecificSection" style="display: none;">
                            <div class="row mb-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-4">
                                        <strong class="text-dark d-block mb-1" style="font-weight: 600;">Contact & Reference</strong>
                                        <span class="text-muted" id="eventContactReference" style="color: #6c757d;">{{ $lead->first_name }} {{ $lead->last_name }} ({{ $lead->flg_reference ?: 'N/A' }})</span>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="row g-2 mb-2">
                                            <div class="col-md-4">
                                                <select class="form-select form-select-sm" id="eventStartType" name="event_start_type">
                                                    <option value="specific_date_time" selected>Specific Date & Time</option>
                                                    <option value="relative">Relative</option>
                                                    <option value="no_date">No Date</option>
                                                </select>
                                            ...
                                            <div class="col-md-8 d-flex align-items-center">
                                                <div class="form-check me-3">
                                                    <input class="form-check-input" type="checkbox" id="eventPrioritise" name="event_priority_check">
                                                    <label class="form-check-label" for="eventPrioritise">Prioritise</label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row g-2 mb-2">
                                            <div class="col-auto">
                                                <select class="form-select form-select-sm" id="eventStartMonth" name="event_start_month" style="width: 80px;">
                                                    @for($i = 1; $i <= 12; $i++)
                                                        <option value="{{ str_pad($i, 2, '0', STR_PAD_LEFT) }}" {{ date('m') == $i ? 'selected' : '' }}>{{ str_pad($i, 2, '0', STR_PAD_LEFT) }}</option>
                                                    @endfor
                                                </select>
                                            ...
                                            <div class="col-auto">
                                                <select class="form-select form-select-sm" id="eventStartDay" name="event_start_day" style="width: 70px;">
                                                    @for($i = 1; $i <= 31; $i++)
                                                        <option value="{{ str_pad($i, 2, '0', STR_PAD_LEFT) }}" {{ date('d') == $i ? 'selected' : '' }}>{{ str_pad($i, 2, '0', STR_PAD_LEFT) }}</option>
                                                    @endfor
                                                </select>
                                            ...
                                            <div class="col-auto">
                                                <select class="form-select form-select-sm" id="eventStartYear" name="event_start_year" style="width: 90px;">
                                                    @for($i = date('Y'); $i <= date('Y') + 5; $i++)
                                                        <option value="{{ $i }}" {{ date('Y') == $i ? 'selected' : '' }}>{{ $i }}</option>
                                                    @endfor
                                                </select>
                                            ...
                                            <div class="col-auto">
                                                <select class="form-select form-select-sm" id="eventStartHour" name="event_start_hour" style="width: 70px;">
                                                    @for($i = 0; $i <= 23; $i++)
                                                        <option value="{{ str_pad($i, 2, '0', STR_PAD_LEFT) }}" {{ date('H') == $i ? 'selected' : '' }}>{{ str_pad($i, 2, '0', STR_PAD_LEFT) }}</option>
                                                    @endfor
                                                </select>
                                            ...
                                            <div class="col-auto">
                                                <select class="form-select form-select-sm" id="eventStartMinute" name="event_start_minute" style="width: 70px;">
                                                    @for($i = 0; $i <= 59; $i += 1)
                                                        <option value="{{ str_pad($i, 2, '0', STR_PAD_LEFT) }}" {{ date('i') == $i ? 'selected' : '' }}>{{ str_pad($i, 2, '0', STR_PAD_LEFT) }}</option>
                                                    @endfor
                                                </select>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="row g-2 mb-2">
                                            <div class="col-auto">
                                                <select class="form-select form-select-sm" id="eventEndMonth" name="event_end_month" style="width: 80px;">
                                                    @for($i = 1; $i <= 12; $i++)
                                                        <option value="{{ str_pad($i, 2, '0', STR_PAD_LEFT) }}" {{ date('m') == $i ? 'selected' : '' }}>{{ str_pad($i, 2, '0', STR_PAD_LEFT) }}</option>
                                                    @endfor
                                                </select>
                                            ...
                                            <div class="col-auto">
                                                <select class="form-select form-select-sm" id="eventEndDay" name="event_end_day" style="width: 70px;">
                                                    @for($i = 1; $i <= 31; $i++)
                                                        <option value="{{ str_pad($i, 2, '0', STR_PAD_LEFT) }}" {{ date('d') == $i ? 'selected' : '' }}>{{ str_pad($i, 2, '0', STR_PAD_LEFT) }}</option>
                                                    @endfor
                                                </select>
                                            ...
                                            <div class="col-auto">
                                                <select class="form-select form-select-sm" id="eventEndYear" name="event_end_year" style="width: 90px;">
                                                    @for($i = date('Y'); $i <= date('Y') + 5; $i++)
                                                        <option value="{{ $i }}" {{ date('Y') == $i ? 'selected' : '' }}>{{ $i }}</option>
                                                    @endfor
                                                </select>
                                            ...
                                            <div class="col-auto">
                                                <select class="form-select form-select-sm" id="eventEndHour" name="event_end_hour" style="width: 70px;">
                                                    @for($i = 0; $i <= 23; $i++)
                                                        <option value="{{ str_pad($i, 2, '0', STR_PAD_LEFT) }}" {{ date('H') == $i ? 'selected' : '' }}>{{ str_pad($i, 2, '0', STR_PAD_LEFT) }}</option>
                                                    @endfor
                                                </select>
                                            ...
                                            <div class="col-auto">
                                                <select class="form-select form-select-sm" id="eventEndMinute" name="event_end_minute" style="width: 70px;">
                                                    @for($i = 0; $i <= 59; $i += 1)
                                                        <option value="{{ str_pad($i, 2, '0', STR_PAD_LEFT) }}" {{ date('i') == $i ? 'selected' : '' }}>{{ str_pad($i, 2, '0', STR_PAD_LEFT) }}</option>
                                                    @endfor
                                                </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-4">
                                        <strong class="text-dark d-block mb-1" style="font-weight: 600;">Status & Assigned User</strong>
                                        <span class="text-muted" id="eventStatusAssignedUser" style="color: #6c757d;">{{ $lead->status ? $lead->status->name : 'New' }}@if($lead->addedBy) ({{ $lead->addedBy->name }})@endif</span>
                                    </div>
                            ...
                            <div class="mb-4">
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    ...
                                    <div class="dropdown">
                                        <button class="btn btn-sm btn-outline-secondary dropdown-toggle" type="button" id="insertEventTextDropdown" data-bs-toggle="dropdown">
                                            Insert Text
                                        </button>
                                        <ul class="dropdown-menu" aria-labelledby="insertEventTextDropdown">
                                            <li><a class="dropdown-item" href="javascript:void(0);" onclick="insertEventText('Call Requested')">Call Requested</a></li>
                                            <li><a class="dropdown-item" href="javascript:void(0);" onclick="insertEventText('Make Initial Call')">Make Initial Call</a></li>
                                            <li><a class="dropdown-item" href="javascript:void(0);" onclick="insertEventText('Send Initial Email')">Send Initial Email</a></li>
                                            <li><a class="dropdown-item" href="javascript:void(0);" onclick="insertEventText('Send Initial Letter')">Send Initial Letter</a></li>
                                            <li><a class="dropdown-item" href="javascript:void(0);" onclick="insertEventText('Make Follow-Up Call')">Make Follow-Up Call</a></li>
                                            <li><a class="dropdown-item" href="javascript:void(0);" onclick="insertEventText('Send Follow-Up Email')">Send Follow-Up Email</a></li>
                                            <li><a class="dropdown-item" href="javascript:void(0);" onclick="insertEventText('Send Follow-Up Letter')">Send Follow-Up Letter</a></li>
                                            <li><a class="dropdown-item" href="javascript:void(0);" onclick="insertEventText('Review Lead')">Review Lead</a></li>
                                            <li><a class="dropdown-item" href="javascript:void(0);" onclick="insertEventText('Process Lead')">Process Lead</a></li>
                                            <li><a class="dropdown-item" href="javascript:void(0);" onclick="insertEventText('Close Lead')">Close Lead</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <textarea class="form-control" id="eventDetails" name="field_1" rows="8" placeholder="Enter event details..." style="resize: vertical; border: 1px solid #dee2e6;"></textarea>
                            </div>

                            <!-- Bottom Action Section -->
                            <div class="mb-3">
                                <div class="form-check mb-2">
                                    <input class="form-check-input" type="checkbox" id="eventAssignLeadToUser" name="assign_lead_to_user">
                                    <label class="form-check-label" for="eventAssignLeadToUser">Assign Lead to User</label>
                                </div>
                                <div class="form-check mb-2">
                                    <input class="form-check-input" type="checkbox" id="createEventCheck" name="create_event_check" checked>
                                    <label class="form-check-label" for="createEventCheck">Create a</label>
                                    <select class="form-select form-select-sm d-inline-block ms-2" id="createEventType" name="create_event_type" style="width: 120px; display: inline-block;">
                        ...
                        <div class="row g-3" id="standardFields">
                            ...
                            <div class="col-12" id="descriptionField">
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-1" id="emailBodyActions" style="display: none;">
                                    <small class="text-muted">Type or paste plain text - it will be automatically converted to HTML format when saved</small>
                                </div>
                                ...
                                <small class="text-muted" id="emailBodyHint" style="display: none;">Tip: Type or paste plain text here. It will be automatically converted to HTML format (with line breaks and links) when saved.</small>
                            </div>
                        </div>

                        <!-- Note Details Section (for Note type) -->
                        <div id="noteDetailsSection" style="display: none;">
                            <label for="activityDescriptionNote" class="form-label text-dark mb-2" style="font-weight: 500;">Note Details:</label>
                            ...
                            <div class="col-12" id="emailFields" style="display: none;">
                                <div class="row g-2">
                                    <div class="col-12">
                                        <label for="activityEmail" class="form-label">Email Address <span class="text-danger">*</span></label>
                                        <input type="email" class="form-control" id="activityEmail" name="email"
                                            placeholder="recipient@example.com" required>
                                    </div>
                                    <div class="col-12">
                                        <label for="activityEmailSubject" class="form-label">Subject <span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="file" class="form-control" id="activityEmailAttachment" name="file" multiple>
                            ...
                            <div id="documentUploadSection" style="display: none;">
                                <div class="mb-4">
                                    ...
                                    <div class="document-upload-area" id="documentUploadArea">
                                        ...
                                        <label for="documentFileInput" class="document-browse-btn" id="documentBrowseBtn" style="cursor: pointer; margin: 0; display: inline-block;">
                                            Browse Files
                                        </label>
                                        <input type="file" id="documentFileInput" name="document_files[]" multiple style="position: absolute; width: 1px; height: 1px; opacity: 0; overflow: hidden; clip: rect(0, 0, 0, 0);">
                                    </div>
                    ...
                    <div class="modal-footer" style="background-color: #fff; border-top: 1px solid #dee2e6;">
                        <div class="d-flex justify-content-between w-100 align-items-center">
                            <button type="button" class="btn btn-outline-primary" id="taskNextBtn" style="display: none;">Next</button>
                            <div class="d-flex gap-2">
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                                <button type="button" class="btn btn-primary" id="activitySubmitBtn" style="pointer-events: auto !important; cursor: pointer !important;">Save Activity</button>
                            </div>
                        </div>
                    </div>
                </form>
    ...
    @push('scripts')
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                $(document).on('click', '.btn-group .dropdown-toggle', function(e) {
                    ...
                    $('body > .dropdown-menu-temp').each(function() {
                        ...
                        if (originalParent && originalParent.length && originalParent.is($btnGroup)) {
                            $tempMenu.removeClass('dropdown-menu-temp').removeData('original-parent').appendTo($btnGroup);
                        }
                    });
                    ...
                    console.log('Menu HTML:', $menu.length > 0 ? $menu[0].outerHTML.substring(0, 100) : 'Not found');
                    ...
                    if ($menu.length) {
                        ...
                        console.log('Computed styles - Display:', computedDisplay, 'Visibility:', computedVisibility, 'Opacity:', computedOpacity, 'Position:', computedPosition);
                        console.log('Bounding rect:', rect);

                        // Close all other dropdowns first
                        $('.btn-group .dropdown-menu').not($menu).removeClass('show').attr('style', 'display: none !important; visibility: hidden !important; opacity: 0 !important;');
                        ...
                        $('body > .dropdown-menu-temp').not($menu).each(function() {
                            ...
                            if ($otherParent && $otherParent.length) {
                                $otherMenu.removeClass('dropdown-menu-temp show').removeData('original-parent').attr('style', 'display: none !important; visibility: hidden !important; opacity: 0 !important;').appendTo($otherParent);
                            }
                        });
                        ...
                        if (isCurrentlyOpen) {
                            // Close it
                            $menu.removeClass('show').attr('style', 'display: none !important; visibility: hidden !important; opacity: 0 !important;');
                            // If it was moved to body, move it back
                            if ($menu.parent().is('body')) {
                                $menu.removeClass('dropdown-menu-temp').removeData('original-parent').appendTo($btnGroup);
                            }
                            ...
                            console.log('Button offset:', buttonOffset, 'Button height:', buttonHeight, 'Scroll:', scrollTop, scrollLeft);
                            ...
                            setTimeout(function() {
                                ...
                                setTimeout(function() {
                                    ...
                                    const finalDisplay = window.getComputedStyle(menuEl).display;
                                    const finalVisibility = window.getComputedStyle(menuEl).visibility;
                                    const finalOpacity = window.getComputedStyle(menuEl).opacity;
                                    console.log('After opening - Display:', finalDisplay, 'Visibility:', finalVisibility, 'Opacity:', finalOpacity);
                                    console.log('Rect:', finalRect);
                                    console.log('Menu is visible:', finalDisplay === 'block' && finalVisibility === 'visible' && finalRect.width > 0 && finalRect.height > 0);
                                    
                                    if (finalDisplay !== 'block' || finalRect.width === 0) {
                                        console.error('Dropdown still not visible! Trying alternative method...');
                ...
                $(document).on('click', function(e) {
                    if (!$(e.target).closest('.btn-group').length && !$(e.target).closest('.dropdown-menu').length) {
                        ...
                        $('body > .dropdown-menu-temp').each(function() {
                            ...
                            if ($btnGroup && $btnGroup.length) {
                                $menu.removeClass('dropdown-menu-temp show').removeData('original-parent').css({
                                    'display': 'none',
                                    'visibility': 'hidden'
                                }).appendTo($btnGroup);
                            }
            ...
            window.showActivityFields = function(type) {
                ...
                $('#emailFields, #phoneFields, #priorityField, #dueDateField, #endDateField, #field1Container, #field2Container, #noteInfoSections, #noteDetailsSection, #taskSpecificSection, #eventSpecificSection, #viewCalendarLink, #taskNextBtn, #emailBodyActions, #documentUploadSection').hide();
                $('#standardFields').show();
                $('#openLeadLink').hide();
            ...
            $(document).on('change', '#activityEmailAttachment', function() {
                ...
                if (files.length > 0) {
                    let fileList = '<div class="alert alert-info"><i class="bi bi-paperclip me-2"></i><strong>Selected Files:</strong><ul class="mb-0 mt-2">';
            ...
            window.previewDocumentFile = function(index) {
                ...
                // Text files
                else if (fileType.startsWith('text/') || fileName.endsWith('.txt') || fileName.endsWith('.csv') || fileName.endsWith('.json') || fileName.endsWith('.xml') || fileName.endsWith('.html') || fileName.endsWith('.css') || fileName.endsWith('.js')) {
                    const reader = new FileReader();
                    reader.onload = function(e) {
                        previewBody.html(`
            ...
            window.previewDocumentFromServer = function(activityId) {
                ...
                // Show loading state
                previewBody.html('<div class="text-center p-4"><div class="spinner-border text-primary" role="status"><span class="visually-hidden">Loading...</span></div></div>');
                        ...
                        if (response.success && response.activity) {
                            ...
                            if (activity.file) {
                                if (typeof activity.file === 'string') {
                                    files = activity.file.split(',').map(f => f.trim()).filter(f => f.length > 0);
                            ...
                            if (files.length === 0) {
                                ...
                                files.forEach(function(filePath, index) {
                                    ...
                                    if (['jpg', 'jpeg', 'png', 'gif', 'webp', 'svg'].includes(fileExtension)) {
                                        ...
                                        `;
                                    } else if (['txt', 'csv', 'json', 'xml', 'html', 'css', 'js', 'md'].includes(fileExtension)) {
                                ...
                                files.forEach(function(filePath, index) {
                                    ...
                                    if (['txt', 'csv', 'json', 'xml', 'html', 'css', 'js', 'md'].includes(fileExtension)) {
                                        // Fetch text file content
                                        fetch(fileUrl)
                                            .then(response => response.text())
                                            .then(text => {
                                                const textPreview = `<pre style="background-color: #f8f9fa; padding: 1rem; border-radius: 4px; overflow-x: auto; white-space: pre-wrap; word-wrap: break-word;">${text}</pre>`;
                                                $(`#text-preview-${index}`).html(textPreview);
                                            })
                                            .catch(err => {
                                                $(`#text-preview-${index}`).html(`<p class="text-muted">Unable to load file content.</p>`);
                                            });
                                    }
                                });
                            }
                ...
                if ($('#emailFields').is(':visible')) {
                    ...
                    if (clipboardData) {
                        ...
                        if (htmlContent && htmlContent.trim()) {
                            ...
                            const end = textarea.selectionEnd;
                            const currentValue = $(textarea).val();
                            const newValue = currentValue.substring(0, start) + textContent + currentValue.substring(end);
                            $(textarea).val(newValue);
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            if (activity.type === 'Email' && activity.file) {
                                ...
                                let fileList = '<div class="alert alert-info"><i class="bi bi-paperclip me-2"></i><strong>Current Attachments:</strong><ul class="mb-0 mt-2">';
                                files.forEach(function(file) {
                                    fileList += `<li>${file}</li>`;
                                });
                                fileList += '</ul><button type="button" class="btn btn-sm btn-outline-danger mt-2" onclick="removeEmailAttachment()">Remove</button></div>';
        ...
        `;
            ...
            function submitActivityForm() {
                ...
                if ($('#eventSpecificSection').is(':visible')) {
                    ...
                    if (eventStartYear && eventStartMonth && eventStartDay) {
                        ...
                        dueDate = `${eventStartYear}-${eventStartMonth}-${eventStartDay} ${eventStartHour}:${eventStartMinute}:00`;
                    }
                ...
                if ($('#emailFields').is(':visible') && $('#activityEmailAttachment').length && $('#activityEmailAttachment')[0].files.length > 0) {
                ...
                if ($('#documentUploadSection').is(':visible') && $('#documentFileInput').length && $('#documentFileInput')[0].files.length > 0) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.success) {
                            ...
                            $('#standardFields, #noteInfoSections, #noteDetailsSection, #emailFields, #phoneFields, #priorityField, #dueDateField, #endDateField, #field1Container, #field2Container, #descriptionField, #openLeadLink, #taskSpecificSection, #viewCalendarLink, #taskNextBtn, #endDateTimeSection, #emailBodyActions').hide();
                    ...
                    error: function(xhr) {
                        ...
                        if (xhr.status === 422) {
                            ...
                            Swal.fire('Error!', 'Failed to save activity. Please check console for details.', 'error');
                        }
                    }
                });
            }
            ...
            $('#activityModal').on('hidden.bs.modal', function() {
                ...
                // Hide all conditional fields
                $('#standardFields, #noteInfoSections, #noteDetailsSection, #emailFields, #phoneFields, #priorityField, #dueDateField, #endDateField, #field1Container, #field2Container, #descriptionField, #openLeadLink, #taskSpecificSection, #eventSpecificSection, #viewCalendarLink, #taskNextBtn, #endDateTimeSection, #emailBodyActions').hide();
                $('#standardFields').show(); // Show standard fields by default
                $('#addEndDateTimeLink').text('- Add an End Date/Time');
