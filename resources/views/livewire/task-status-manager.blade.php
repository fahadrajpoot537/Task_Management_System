        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Task Status Management</h5>
                    ...
                    @if ($showForm)
                        <div class="card mb-4">
                            <div class="card-header">
                                <h6 class="mb-0">{{ $editingId ? 'Edit Status' : 'Add New Status' }}</h6>
                            </div>
                            <div class="card-body">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control @error('name') is-invalid @enderror" 
                                                       id="name" wire:model="name" placeholder="Enter status name">
                            ...
                            <tbody>
                                @forelse ($statuses as $status)
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge bg-{{ $status->color }}">{{ ucfirst($status->color) }}</span>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <span class="badge bg-info">{{ $status->tasks_count ?? $status->tasks()->count() }}</span>
                                        </td>
                                        <td>
                                            <div class="btn-group" role="group">
                                                <button wire:click="edit({{ $status->id }})" class="btn btn-sm btn-outline-primary">
